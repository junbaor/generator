 ...
 * 验证上传文件格式
 */
function  validteUploadFileType(type,suff){
    //var type=['jpg','JPG','png','PNG','gif','GIF'];
    if((Ext.isEmpty(suff))||(!Ext.isEmpty(suff)&&type.indexOf(suff.toLowerCase())==-1)){
        Ext.MessageBox.alert('提示', '上传文件必须是'+type.toString());
        return false;
    }
    return true;
}
