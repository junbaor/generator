...
Ext.ux.SlidingTabPanel = Ext.extend(Ext.TabPanel, {
            initComponent : function() {
                Ext.ux.SlidingTabPanel.superclass.initComponent.call(this);
                this.addEvents('dblclick');
            },
            initEvents : function() {
                Ext.ux.SlidingTabPanel.superclass.initEvents.call(this);
                this.mon(this.strip, {
                            scope: this,
                            dblclick: this.onStripDbClick
                        });
                if (this.enableTabScroll) {
                    this.mon(this.strip, 'mousewheel', this.onWheel, this);
                }
            },
            onStripDbClick:function(e) {
                e.preventDefault();
                var t = this.findTargets(e);
                if (t.item) {
                    this.fireEvent('dblclick', this, t.item, e);
                }
            },
