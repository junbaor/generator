...
import com.common.properties.PropertiesFactory;
import com.common.properties.PropertiesFile;
import com.common.properties.PropertiesHelper;
...
public class G4Utils {
    ...
    public static void copyPropBetweenBeans(Object pFromObj, Object pToObj) {
        if (pToObj != null) {
            try {
                BeanUtils.copyProperties(pFromObj, pToObj);
            } catch (Exception e) {
     ...
     * @throws Exception
     */
    public static String encryptBasedMd5(String target) throws Exception {
                ...
                if ("file".equals(result.getProtocol())) {
                    try {
                        if (result.toExternalForm().endsWith(".jar")
                            ...
                            result =
                                    new URL("jar:".concat(result.toExternalForm()).concat("!/")
     ...
     * @return
     */
    public static String replaceSmsTemplate(String template, String[] messages) {
        for (String message : messages) {
            template = template.replaceFirst("\\$", message);
        }
        return template;
    }
    ...
    public static String getExcelPath() {
        String exportFilePath =
                PropertiesFactory.getPropertiesHelper(PropertiesFile.APP).getValue("export.filePath");
        if (flag) {
